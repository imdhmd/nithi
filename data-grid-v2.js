...
* This contains three objects: DataGrid, Pagination, SortTable and GoToPage
* http://github.com/f1codz/nithi/blob/master/data-grid.js
*
* New in this version:
* -- SortTable
*
* TODO:
* -- Contains ananya specific code (eg startDate, endDate), thus requires clean up
*/
